    ...
    private void initDeviceMark() {
        ...
        aMap.setInfoWindowAdapter(new AMap.InfoWindowAdapter() {
            ...
            public View getInfoWindow(Marker marker) {
                TextView info = new TextView(DeviceDetailActivity.this);
                String infostring = ""
                        + "名称：" + bean.user_name + "\n"
                        + "设备号：" + bean.sim_id + "\n"
...
// 开始滑动
    ...
    public void Nav(){
        ...
        AmapNaviPage.getInstance().showRouteActivity(DeviceDetailActivity.this, new AmapNaviParams(start, wayList, end, AmapNaviType.DRIVER), new INaviInfoCallback() {
            @Override
